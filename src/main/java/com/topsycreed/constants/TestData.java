package com.topsycreed.constants;
...
public class TestData {
    ...
    public static final SuperheroModel SUPERHERO_VALID_WITHOUT_PHONE = new SuperheroModel(3474, "Anton Egorov", "1988-04-08", "Russia, Saint Petersburg", "QA", SuperheroModel.Gender.M.name(), null);
    public static final SuperheroModel SUPERHERO_VALID_WITH_PHONE = new SuperheroModel(3474, "Anton Egorov", "1988-04-08", "Russia, Saint Petersburg", "QA", SuperheroModel.Gender.M.name(), "+79184565502");
